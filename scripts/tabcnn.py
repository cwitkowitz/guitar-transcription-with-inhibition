...
from amt_models.models import TabCNN, LanguageModel, SoftmaxGroups
...
def config():
    ...
    root_dir = '_'.join([TabCNN.model_name(), GuitarSet.dataset_name(), CQT.features_name(), 'delete'])
    # TODO - don't do relative path
...
#        tabcnn.dense[0] = nn.Linear(tabcnn.dense[0].in_features,
#                                    2 * tabcnn.dense[0].out_features)

#        tabcnn.dense[-1] = SoftmaxGroups(tabcnn.dense[0].out_features, profile, 'pitch')

#        tabcnn.dense = nn.Sequential(tabcnn.dense[0],
#                                     LanguageModel(tabcnn.dense[0].out_features,
#                                                   tabcnn.dense[0].out_features),
#                                     *list(tabcnn.dense[1:].children()))
